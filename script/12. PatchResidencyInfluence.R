...
load("./data/HastatusSegClusRelevel.Rdata") #hastP from 7. MergeForagingAreas
...
save(forage, file="./data/AllBatsSamePatch.Rdata")
...
#save(patchStay_df, file="./data/AllBatsPatchStateSeq.Rdata")
