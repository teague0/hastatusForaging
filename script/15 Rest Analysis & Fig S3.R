...
load("./data/AllBatsPatchStateSeq.Rdata") #patchStay_df
load("./data/AllBatsSamePatch.Rdata") #forage
load("./data/HastHMMdbClus_flwTrueTlagTrueGSAS.Rdata") #hast_df 
...
save(hastRest, file = "./data/Resting Site Locations.Rdata.")
...
#Addin activity in /out of same patch from 7. Distance Effects Foraging
load("./processed data/PatchBehaviorActivity.Rdata")

#Create multipanel plot of activity budgets and distance effects on behavior
